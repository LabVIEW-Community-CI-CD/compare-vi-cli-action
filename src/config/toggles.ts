...
export interface ToggleProfileDefinition {
  /**
  ...
  description?: string;
  /**
   * Profile names to inherit before applying this profile.
   */
  extends?: string[];
  /**
   * Toggle assignments applied by this profile.
   */
...
const PROFILE_DEFINITIONS: Record<string, ToggleProfileDefinition> = {
  base: {
    name: 'base',
...
function getProfileDefinition(name: string): ToggleProfileDefinition {
...
export function resolveToggleManifest(options?: ResolveOptions): ToggleManifest {
...
export function getAvailableToggleProfiles(): ToggleProfileDefinition[] {
