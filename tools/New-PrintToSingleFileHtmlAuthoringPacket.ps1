...
$checklistContent = (@(
  ...
  '6. Run tools/Finalize-OperationPayloadSourceBundle.ps1 -BundlePath',
  '   fixtures/headless-corpus/operation-payloads/PrintToSingleFileHtml so the',
  '   bundle flips from source-only to runnable only when real LabVIEW binaries',
  '   are present.',
  '',
  'Reference:',
  '',
