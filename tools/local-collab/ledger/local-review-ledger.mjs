...
export async function writeLocalCollaborationLedgerReceipt(options = {}) {
  ...
  const receipt = {
    ...
    executionPlane: normalizeText(options.executionPlane) || null,
    providerRuntime: normalizeText(options.providerRuntime) || null,
    headSha,
    baseSha,
    providerId,
    providers,
    ...
    inputTokens: normalizeInteger(options.inputTokens),
    cachedInputTokens: normalizeInteger(options.cachedInputTokens),
    outputTokens: normalizeInteger(options.outputTokens),
