...
parser.add_argument('--repo-root', {
  help: 'Repository root containing tools/TestStand-CompareHarness.ps1 (defaults to CWD)'
});
...
const repoRoot = args.repo_root ? resolve(process.cwd(), args.repo_root) : process.cwd();
