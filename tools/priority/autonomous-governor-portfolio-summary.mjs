...
function deriveExecutionTopology(compareGovernorSummary) {
  ...
  if (executionTopology && typeof executionTopology === 'object' && !Array.isArray(executionTopology)) {
    return {
      ...
      harnessKind: asOptional(executionTopology.harnessKind),
      harnessInstanceId: asOptional(executionTopology.harnessInstanceId),
      harnessInstanceLeaseId: asOptional(executionTopology.harnessInstanceLeaseId),
      harnessInstanceLeasePath: asOptional(executionTopology.harnessInstanceLeasePath),
      ...
      executionBundle: {
        ...
        harnessInstanceLeaseId: asOptional(executionTopology?.executionBundle?.harnessInstanceLeaseId),
        harnessInstanceLeasePath: asOptional(executionTopology?.executionBundle?.harnessInstanceLeasePath),
