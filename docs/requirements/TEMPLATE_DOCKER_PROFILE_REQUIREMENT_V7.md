# Template Docker Profile Requirement V7
...
- `TDPR-024` The Template shall remain limited to distribution, cookiecutter
  ...
  `TDPR-005A`, `TDPR-006`, `TDPR-007`, `TDPR-009`, `TDPR-010`, `TDPR-025`, and
  `TDPR-031`.
...
- `Cross-Repo VI History Capture` — internal guidance note —
  ...
  `review-template-docker-profile-requirement-v6` — commit `02bb748b`
